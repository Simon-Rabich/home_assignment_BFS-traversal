...
class Person:
    ...
    def __init__(self,FullName, Addresss):
        self.FullName = Name(FullName.FirstName, FullName.LastName)
        self.Address = Address(Addresss.Street, Addresss.City)
        ...
        for person1 in people:
            for person2 in people:
                ...
                if person1.id != person2.id:
                  ...
                  if (person1.getFullName().getFirstName() is person2.getFullName().getFirstName() and person1.getFullName().getLastName() is person2.getFullName().getLastName()):

                    self.addEdge(person1.id, person2.id)
                    continue

                  if (person1.getAddress().getStreet() == person2.getAddress().getStreet() and person1.getAddress().getCity() == person2.getAddress().getCity()):
